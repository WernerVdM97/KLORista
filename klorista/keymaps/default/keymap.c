...
*/
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              _______,  KC_BSLS,  _______,  _______,  KC_EQL,                        _______,  _______,  _______,  _______,  _______,
    TG(_LOL1),_______,  _______,  KC_LBRC,  KC_RBRC,  _______,                       _______,  _______,  _______,  _______,  _______,  _______,
...
*/
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              _______,  _______,  _______,  _______,  _______,                       KC_EQL,   _______,  _______,  KC_BSLS,  _______,
...
*/
   [_NUM] = LAYOUT_konrad(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              _______,  _______,  _______,  _______,  KC_Y,                          _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  KC_Y,     _______,                       _______,  _______,  _______,  _______,  _______,  _______,
    XXXXXXX,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
