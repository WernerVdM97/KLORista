...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /*
   ...
   │    `    │    A    │    S    │    D    │    F    │    G    ├─╯                ╰─┤    H    │    J    │    K    │    L    │    ;    │    "    │
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │   esc   │    Z    │    X    │    C    │    V    │    B    ││  MUTE  ││ SCRLCK ││    N    │    M    │    ,    │    .    │    /    │   CAPS  │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    KC_ESC,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MUTE,   KC_SCRL,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_CAPS,
 ...
 /*
   ...
   [_BASE2] = LAYOUT_konrad(
              KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,                          KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,
    KC_GRV,   ALT_A,    GUI_S,    SHT_D,    CTL_F,    KC_G,                          KC_H,     CTL_J,    SHT_K,    GUI_L,    ALT_SCL,  KC_QUOT,
    KC_ESC,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_MUTE,   XXXXXXX,  KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_CAPS,
                                  MATHL_BSPC,NAVL_SPC,SYM_TAB,                       SYM_ENT,  NAVR_SPC,MATHR_BSPC  
 ),
 /*
   ╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   ...
   │         │    ▀    │    ←    │    ↑    │    →    │   PG↑   ├─╯                ╰─┤         │         │         │         │         │         │
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │         │         │   HOME  │    ↓    │   END   │   PG↓   ││  SLEEP ││  POWER ││         │         │         │         │         │         │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │    ▼    │    ▼    │    ▼    │                    │         │    _    │   DEL   │
                                 └─────────┴─────────┴─────────┘                    └─────────┴─────────┴─────────┘ */
   [_NAVL] = LAYOUT_konrad(
              XXXXXXX,  KC_MPRV,  KC_MPLY,  KC_MNXT,  XXXXXXX,                       _______,  _______,  _______,  _______,  _______,
    TG(_LOL1),KC_MSTP,  KC_LEFT,  KC_UP,    KC_RGHT,  KC_PGUP,                       _______,  _______,  _______,  _______,  _______,  _______,
    _______,  XXXXXXX,  KC_HOME,  KC_DOWN,  KC_END,   KC_PGDN,  KC_SLEP,   KC_PWR,   _______,  _______,  _______,  _______,  _______,  _______,
 ...
 /*
   ...
   [_NAVR] = LAYOUT_konrad(
    ...
    XXXXXXX,  _______,  _______,  _______,  _______,  _______,  KC_SLEP,   KC_PWR,   KC_PGDN,  KC_HOME,  KC_DOWN, KC_END,   XXXXXXX,  OS_SWAP,
...
/*
   ...
   [_MATHL] = LAYOUT_konrad(
    ...
    TG(_LOL1),S(KC_7),  KC_LBRC,  S(KC_BSLS),KC_RBRC, S(KC_8),                       _______,  _______,  _______,  _______,  _______,  _______,
    XXXXXXX,  S(KC_1),  S(KC_2),  S(KC_3),  S(KC_4),  S(KC_5),  KC_SLEP,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
...
/*
   ...
   [_MATHR] = LAYOUT_konrad(
              _______,  _______,  _______,  _______,  _______,                       KC_EQL,   S(KC_9), KC_BSLS,   S(KC_0),  S(KC_6),
    _______,  _______,  _______,  _______,  _______,  _______,                       S(KC_8),  KC_LBRC, S(KC_BSLS),KC_RBRC,  S(KC_7), _______,
    XXXXXXX,  _______,  _______,  _______,  _______,  _______,  _______,   _______,  S(KC_5),  S(KC_4), S(KC_3),   S(KC_2),  S(KC_1), QK_BOOT,
...
/*
   ...
   │         │    1    │    2    │    3    │    4    │    5    ├─╯                ╰─┤    6    │    7    │    8    │    9    │    0    │         │
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │         │   F11   │   F12   │         │  FIND   │         ││        ││        ││  HELP   │  PRINT  │    ,    │    .    │  INSRT  │         │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┤╰────────╯╰────────╯├─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │         │         │         │                    │         │         │         │
                                 └─────────┴─────────┴─────────┘                    └─────────┴─────────┴─────────┘
*/
  // TODO:
  // - consider dropping F11 and F12 for undo cut copy paste
   [_NUM] = LAYOUT_konrad(
              KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,                         KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,
    _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,                          KC_6   ,  KC_7   ,  KC_8   ,  KC_9   ,  KC_0  , _______,
    XXXXXXX,  KC_F11,   KC_F12,   _______,  KC_FIND,  _______,  _______,   _______,  KC_HELP,  KC_PSCR,  _______,  _______,  KC_INS, _______,
